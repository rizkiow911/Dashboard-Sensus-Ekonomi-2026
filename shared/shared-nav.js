    ...
    mount.innerHTML = `
      <div class="header-bar">
        <div class="brand">
          ...
          <span class="brand-title brand-title-marquee" aria-label="Dashboard Pemantauan Sensus Ekonomi">
            <span class="marquee-track">
              <span class="marquee-text">Dashboard Pemantauan Sensus Ekonomi</span>
              <span class="marquee-text" aria-hidden="true">Dashboard Pemantauan Sensus Ekonomi</span>
            </span>
          </span>
        </div>
