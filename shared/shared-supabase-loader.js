...
(function () {
  ...
  // sudah difilter status='BPS Jakarta Timur' DI VIEW), Bagian 2 (rekap
  // kecamatan x status, semua status), Bagian 3 (detail hasil pendataan
  // per petugas, digabung dengan hitungan "Belum Diproses" dari tabel
  // dasar — SATU-SATUNYA tempat tabel dasar ub_se2026_bps3172 dibaca
  // langsung, dan hanya dua kolom: petugas, pml).
  // ---------------------------------------------------------------------
  function ubTables() {
    const cfg = window.APP_CONFIG || {};
