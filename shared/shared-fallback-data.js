...
window.FALLBACK_DATA = {
  ...
  petugasProgres: {
    ppl: [
      { kecamatan: "Matraman", nama: "Andi Saputra", jumlahSls: 12, prelist: 480, hasilPendataan: 410, progresPendataanPct: 85.4, prelistUsaha: 90, hasilUsahaBku: 76, progresUsahaBkuPct: 84.4, hasilUsahaRumahTangga: 55, prelistKeluarga: 480, hasilPendataanKeluarga: 400, progresKeluargaPct: 83.3 },
      { kecamatan: "Matraman", nama: "Budi Santoso", jumlahSls: 10, prelist: 400, hasilPendataan: 120, progresPendataanPct: 30.0, prelistUsaha: 70, hasilUsahaBku: 18, progresUsahaBkuPct: 25.7, hasilUsahaRumahTangga: 12, prelistKeluarga: 400, hasilPendataanKeluarga: 110, progresKeluargaPct: 27.5 },
      { kecamatan: "Cakung", nama: "Citra Dewi", jumlahSls: 14, prelist: 560, hasilPendataan: 300, progresPendataanPct: 53.6, prelistUsaha: 100, hasilUsahaBku: 58, progresUsahaBkuPct: 58.0, hasilUsahaRumahTangga: 40, prelistKeluarga: 560, hasilPendataanKeluarga: 290, progresKeluargaPct: 51.8 },
      { kecamatan: "Cakung", nama: "Dedi Firmansyah", jumlahSls: 11, prelist: 440, hasilPendataan: 90, progresPendataanPct: 20.5, prelistUsaha: 80, hasilUsahaBku: 15, progresUsahaBkuPct: 18.8, hasilUsahaRumahTangga: 9, prelistKeluarga: 440, hasilPendataanKeluarga: 85, progresKeluargaPct: 19.3 }
    ],
    pml: [
      { kecamatan: "Matraman", nama: "Eka Wijaya", jumlahPetugas: 2, jumlahSls: 22, prelist: 880, hasilPendataan: 460, progresPendataanPct: 52.3, prelistUsaha: 160, hasilUsahaBku: 82, progresUsahaBkuPct: 51.3, hasilUsahaRumahTangga: 60, prelistKeluarga: 880, hasilPendataanKeluarga: 450, progresKeluargaPct: 51.1 },
      { kecamatan: "Cakung", nama: "Fajar Nugroho", jumlahPetugas: 2, jumlahSls: 25, prelist: 1000, hasilPendataan: 350, progresPendataanPct: 35.0, prelistUsaha: 180, hasilUsahaBku: 62, progresUsahaBkuPct: 34.4, hasilUsahaRumahTangga: 44, prelistKeluarga: 1000, hasilPendataanKeluarga: 340, progresKeluargaPct: 34.0 }
    ]
  },
  ...
  // shared-config.js. Contoh kecil saja (2 PML x 2 PPL, 4 hari, 3
  // kecamatan), cukup memperlihatkan bentuk tren, stacked bar, & matrix
  // hasil saat Supabase belum tersambung.
  usahaBesarUB: {
    // Bagian 1 — v_progres_pegawai_harian (sudah difilter status='BPS Jakarta Timur').
    pegawaiHarian: [
      { tanggalSnapshot: "2026-07-30", petugas: "Andi Saputra", pml: "Eka Wijaya", totalAlokasi: 18, submit: 4, sudahDiproses: 6, belumDiproses: 12, persenSubmit: 22.2 },
      { tanggalSnapshot: "2026-07-30", petugas: "Budi Santoso", pml: "Eka Wijaya", totalAlokasi: 15, submit: 2, sudahDiproses: 3, belumDiproses: 12, persenSubmit: 13.3 },
      { tanggalSnapshot: "2026-07-30", petugas: "Citra Dewi", pml: "Fajar Nugroho", totalAlokasi: 20, submit: 5, sudahDiproses: 8, belumDiproses: 12, persenSubmit: 25.0 },
      { tanggalSnapshot: "2026-07-30", petugas: "Dedi Firmansyah", pml: "Fajar Nugroho", totalAlokasi: 16, submit: 3, sudahDiproses: 5, belumDiproses: 11, persenSubmit: 18.8 },
      { tanggalSnapshot: "2026-07-31", petugas: "Andi Saputra", pml: "Eka Wijaya", totalAlokasi: 18, submit: 7, sudahDiproses: 10, belumDiproses: 8, persenSubmit: 38.9 },
      { tanggalSnapshot: "2026-07-31", petugas: "Budi Santoso", pml: "Eka Wijaya", totalAlokasi: 15, submit: 4, sudahDiproses: 6, belumDiproses: 9, persenSubmit: 26.7 },
      { tanggalSnapshot: "2026-07-31", petugas: "Citra Dewi", pml: "Fajar Nugroho", totalAlokasi: 20, submit: 9, sudahDiproses: 13, belumDiproses: 7, persenSubmit: 45.0 },
      { tanggalSnapshot: "2026-07-31", petugas: "Dedi Firmansyah", pml: "Fajar Nugroho", totalAlokasi: 16, submit: 5, sudahDiproses: 8, belumDiproses: 8, persenSubmit: 31.3 },
      { tanggalSnapshot: "2026-08-01", petugas: "Andi Saputra", pml: "Eka Wijaya", totalAlokasi: 18, submit: 10, sudahDiproses: 14, belumDiproses: 4, persenSubmit: 55.6 },
      { tanggalSnapshot: "2026-08-01", petugas: "Budi Santoso", pml: "Eka Wijaya", totalAlokasi: 15, submit: 5, sudahDiproses: 8, belumDiproses: 7, persenSubmit: 33.3 },
      { tanggalSnapshot: "2026-08-01", petugas: "Citra Dewi", pml: "Fajar Nugroho", totalAlokasi: 20, submit: 13, sudahDiproses: 17, belumDiproses: 3, persenSubmit: 65.0 },
      { tanggalSnapshot: "2026-08-01", petugas: "Dedi Firmansyah", pml: "Fajar Nugroho", totalAlokasi: 16, submit: 7, sudahDiproses: 10, belumDiproses: 6, persenSubmit: 43.8 },
      { tanggalSnapshot: "2026-08-02", petugas: "Andi Saputra", pml: "Eka Wijaya", totalAlokasi: 18, submit: 13, sudahDiproses: 16, belumDiproses: 2, persenSubmit: 72.2 },
      { tanggalSnapshot: "2026-08-02", petugas: "Budi Santoso", pml: "Eka Wijaya", totalAlokasi: 15, submit: 6, sudahDiproses: 9, belumDiproses: 6, persenSubmit: 40.0 },
      { tanggalSnapshot: "2026-08-02", petugas: "Citra Dewi", pml: "Fajar Nugroho", totalAlokasi: 20, submit: 16, sudahDiproses: 19, belumDiproses: 1, persenSubmit: 80.0 },
      { tanggalSnapshot: "2026-08-02", petugas: "Dedi Firmansyah", pml: "Fajar Nugroho", totalAlokasi: 16, submit: 8, sudahDiproses: 12, belumDiproses: 4, persenSubmit: 50.0 }
    ],

    // Bagian 2 — v_progres_kategori_kecamatan (semua status, tidak difilter).
    kategoriKecamatan: [
      { kecamatan: "Matraman", status: "BPS Jakarta Timur", jumlah: 18 },
      { kecamatan: "Matraman", status: "JIEP", jumlah: 6 },
      { kecamatan: "Matraman", status: "STIS", jumlah: 3 },
      { kecamatan: "Matraman", status: "Rutinan", jumlah: 4 },
      { kecamatan: "Matraman", status: "Data Kantor Pusat", jumlah: 2 },
      { kecamatan: "Matraman", status: "RI", jumlah: 1 },
      { kecamatan: "Cakung", status: "BPS Jakarta Timur", jumlah: 36 },
      { kecamatan: "Cakung", status: "JIEP", jumlah: 42 },
      { kecamatan: "Cakung", status: "STIS", jumlah: 5 },
      { kecamatan: "Cakung", status: "Rutinan", jumlah: 7 },
      { kecamatan: "Cakung", status: "Data Kantor Pusat", jumlah: 3 },
      { kecamatan: "Cakung", status: "RI", jumlah: 2 },
      { kecamatan: "Duren Sawit", status: "BPS Jakarta Timur", jumlah: 15 },
      { kecamatan: "Duren Sawit", status: "JIEP", jumlah: 4 },
      { kecamatan: "Duren Sawit", status: "STIS", jumlah: 2 },
      { kecamatan: "Duren Sawit", status: "Rutinan", jumlah: 5 },
      { kecamatan: "Duren Sawit", status: "Data Kantor Pusat", jumlah: 1 },
      { kecamatan: "Duren Sawit", status: "RI", jumlah: 1 }
    ],
